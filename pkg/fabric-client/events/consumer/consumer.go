...
func NewEventsClient(provider fab.ProviderContext, identity fab.IdentityContext, peerAddress string, certificate *sm2.Certificate,
...
func newEventsClientConnectionWithAddress(peerAddress string, cert *sm2.Certificate, serverHostOverride string,
