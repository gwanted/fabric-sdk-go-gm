...
func newIdentity(cert *sm2.Certificate, pk apicryptosuite.Key, msp *bccspmsp) (Identity, error) {
...
func newSigningIdentity(cert *sm2.Certificate, pk apicryptosuite.Key, signer crypto.Signer, msp *bccspmsp) (SigningIdentity, error) {
